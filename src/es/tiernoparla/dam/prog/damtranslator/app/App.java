...
public class App {
    ...
    public static final String MSG_FILE_NAME_ES = "Insert the name of the file you want to translate (The file needs to be in: src/es/tiernoparla/dam/prog/damtranslator/files/EsToEng/): ";
    public static final String MSG_FILE_NAME_ENG = "Insert the name of the file you want to translate (The file needs to be in: src/es/tiernoparla/dam/prog/damtranslator/files/EngToEs): ";
    ...
    public static final String DICTIONARY_PATH_ES = "src/es/tiernoparla/dam/prog/damtranslator/files/dictionary/dictionary.txt";
    public static final String DICTIONARY_PATH_ENG = "src/es/tiernoparla/dam/prog/damtranslator/files/dictionary/engdictionary.txt";
    ...
    public static void main(String[] args) throws Exception {
        ...
        Dictionary dictionaryEs = new Dictionary(DICTIONARY_PATH_ES, DICTIONARY_SEPARATOR);
        Dictionary dictionaryEng = new Dictionary(DICTIONARY_PATH_ENG, DICTIONARY_SEPARATOR);
        ...
        switch (choice) {
            case 1:
                System.out.print(MSG_FILE_NAME_ES);
            ...
            case 2:
                System.out.print(MSG_FILE_NAME_ENG);
